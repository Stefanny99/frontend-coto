  ...
  return (
    <div className="sidebar-wrapper d-flex flex-column hover-menu-items-parent">
      ...
      <div className="list-group mb-auto" id="list-tab">
        <div
          className={`list-group-item menu-items-var list-group-item-action ${
            history.location.pathname.split("/")[1] === "inicio" ? "active" : ""
          }`}
          id="list-home-list"
        ...
        <div
          className={`list-group-item menu-items-var list-group-item-action ${
            history.location.pathname.split("/")[1] === "socios" ? "active" : ""
          }`}
          id="list-socios-list"
          onClick={() => history.push("/socios")}
          aria-controls="list-socios"
        >
        ...
        <div
          className={`list-group-item menu-items-var list-group-item-action ${
            history.location.pathname.split("/")[1] === "inventario"
              ? "active"
              : ""
          }`}
        ...
        <div
          className={`list-group-item menu-items-var list-group-item-action ${
            history.location.pathname.split("/")[1] === "ordenes"
              ? "active"
              : ""
          }`}
